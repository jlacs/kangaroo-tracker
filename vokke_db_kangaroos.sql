...
--
-- Host: localhost    Database: vokke_db
-- ------------------------------------------------------
...
CREATE TABLE `kangaroos` (
  ...
  `friendliness` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `birthday` date NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `kangaroos_id_unique` (`id`)
...
-- Dump completed on 2022-08-25 20:32:09
